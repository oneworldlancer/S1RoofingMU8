...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.ScreenChatShow
{
    ...
    public partial class Row_ScreenChatShow_Message_Command_Copy_Owner_View : ContentView
    {
        public Row_ScreenChatShow_Message_Command_Copy_Owner_View()
        {
            InitializeComponent();
          ...
          //  IconTintColorEffect.SetTintColor(imgBtn_Copy, Colors.Red);



            //  IconTintColorEffect.SetTintColor(imgBtn_Speak, Colors.Orange);
        ...
        public static BindableProperty iOwnerModelProperty =
            BindableProperty.Create(
                ...
                typeof(Row_ScreenChatShow_Message_Command_Copy_Owner_View),
        ...
        public static BindableProperty iGroupModelProperty =
            BindableProperty.Create(nameof(iGroupModel), typeof(SRoofingScreenChatShowMessageModelManager), typeof(Row_ScreenChatShow_Message_Command_Copy_Owner_View), new SRoofingScreenChatShowMessageModelManager(),
                BindingMode.TwoWay);
        ...
        public static readonly BindableProperty Command_Chat_ByUserProperty = BindableProperty.Create(nameof(Command_Chat_ByUser), typeof(ICommand), typeof(Row_ScreenChatShow_Message_Command_Copy_Owner_View), null);
        ...
        public static readonly BindableProperty Command_CopyToClipboardProperty = BindableProperty.Create(nameof(Command_CopyToClipboard), typeof(ICommand), typeof(Row_ScreenChatShow_Message_Command_Copy_Owner_View), null);
        public ICommand Command_CopyToClipboard
        {
            get => (ICommand)GetValue(Command_CopyToClipboardProperty);
            set => SetValue(Command_CopyToClipboardProperty, value);
        }
        ...
        void Initialize_Command()
        {
            ...
            try
            {
                ...
                //Command_CopyToClipboard = new Command(async () => {

                //    try
                //    {

                //        await Clipboard.SetTextAsync(iGroupModel.MessageText_Translated);
                ...
                //            ItemText = "copy_message",
                //            ItemValue = iGroupModel.MessageText_Translated

                //        };

                //        MessagingCenter.Send<App, object>(
                //App.Current as App,
                //"Page_Chat_Dashboard", iBroadcastModel);
        ...
        async void imgBtn_Copy_Clicked(object sender, EventArgs e)
        {
            try
            {
