...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.ScreenChatShow
{
    ...
    public partial class Row_ScreenChatShow_Message_Avatar_Remote_View : ContentView
    {
        public Row_ScreenChatShow_Message_Avatar_Remote_View()
        {
            InitializeComponent();
            // 
    ...
    if (iGroupModel != null)
                {
                    ...
                    lbl_AvatarName.Text = iGroupModel.AvatarName;
