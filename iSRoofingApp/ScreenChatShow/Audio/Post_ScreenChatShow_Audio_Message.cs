...
{
    public class Post_ScreenChatShow_Audio_Message
    {


        public static async Task Post_ScreenChatShowAudio_MessageWS (
 ...
 */
                ...
                iSRoofingScreenChatShowMessageDatabaseModel.MessageType = "textshareaudio";//iTranslationModel.MessageType;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageText = iLanguageModel.lblText_ScreenChatShow_ShareAudio_Message;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageCode_Translated = iTranslationModel.MessageCode_Translated;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageText_Translated = iLanguageModel.lblText_ScreenChatShow_ShareAudio_Message;// iTranslationModel.MessageText_Translated;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageCode_Original = iTranslationModel.MessageCode_Original;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageText_Original = iLanguageModel.lblText_ScreenChatShow_ShareAudio_Message;//iTranslationModel.MessageText_Original;
                ...
                iSRoofingScreenChatShowMessageDatabaseModel.MessageTextHistoryLine = SRoofingEnum_MessageText_HistoryLine_Code.MessageHistoryLineCode_Audio;


                iSRoofingScreenChatShowMessageDatabaseModel.ImageDefaultServerID = ImageID;
                iSRoofingScreenChatShowMessageDatabaseModel.ImageDefaultServerURL = SRoofing_URLManager.URL_Audio.Audio_Get_AudioDataByAudioID ( App.Current , ImageID );
                iSRoofingScreenChatShowMessageDatabaseModel.ImageThumServerURL = "0";// SRoofing_URLManager.URL_Image.Image_Get_ImageByImageID ( App.Current, ImageID );  
                ...
                iSRoofingScreenChatShowMessageDatabaseModel.ImageDefaultPath = fileResult.FullPath;



                iSRoofingScreenChatShowMessageDatabaseModel.MediaFile_Code = SRoofingEnum_File_Code.FileCode_Audio; //"0";
                iSRoofingScreenChatShowMessageDatabaseModel.MediaFile_Type = SRoofingEnum_File_Type.ShareType_Audio; //"0";
                iSRoofingScreenChatShowMessageDatabaseModel.MediaFile_Size = iUserMediaModel.MediaFile_Size;
                iSRoofingScreenChatShowMessageDatabaseModel.MediaFile_Duration = iUserMediaModel.MediaFile_Duration;
                iSRoofingScreenChatShowMessageDatabaseModel.MediaFile_Extension = SRoofingEnum_File_Extension.FileExtension_Audio_MP3; //"0";
                iSRoofingScreenChatShowMessageDatabaseModel.MediaFile_Thum = SRoofingEnum_File_Thum.FileThum_Audio; //"0";
                ...
                _ = Task.Run ( async ( ) =>
                 {
                     ...
                     SRoofingScreenChatShowHistoryMessageModelManager _iHistoryChatMessageModel = new SRoofingScreenChatShowHistoryMessageModelManager
                     {
                         ...
                         MessageText = iLanguageModel.lblText_ScreenChatShow_ShareAudio_Message ,
