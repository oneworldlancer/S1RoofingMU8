...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.History.Call
    ...
    public partial class Row_Call_IsNewMessage_FALSE_IN_View : ContentView
        {
        public Row_Call_IsNewMessage_FALSE_IN_View ( )
            {
            InitializeComponent ( );
            }
        ...
        public static BindableProperty iOwnerModelProperty =
            BindableProperty.Create(
                ...
                typeof(Row_Call_IsNewMessage_FALSE_IN_View),
        ...
        public static BindableProperty iGroupModelProperty =
            BindableProperty.Create ( nameof ( iGroupModel ) , typeof ( SRoofingScreenCallShowHistoryMessageModelManager ) , typeof ( Row_Call_IsNewMessage_FALSE_IN_View ) , new SRoofingScreenCallShowHistoryMessageModelManager ( ) ,
                BindingMode.TwoWay );
        ...
        public static readonly BindableProperty Command_Call_ByUserProperty = BindableProperty.Create ( nameof ( Command_Call_ByUser ) , typeof ( ICommand ) , typeof ( Row_Call_IsNewMessage_FALSE_IN_View ) , null );
