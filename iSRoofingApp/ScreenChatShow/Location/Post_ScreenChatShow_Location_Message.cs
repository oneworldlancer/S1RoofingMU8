...
{
    public class Post_ScreenChatShow_Location_Message
    {



        public static async Task Post_ScreenChatShowLocation_MessageWS (
 ...
 */
                ...
                MessageText= iLocationModel.LocationTitle;

                string _StaticMapURL = SRoofing_URLManager.URL_Map.Map_Get_GetStaticMapThumURL ( iLocationModel.LocationLatitude , iLocationModel.LocationLongitude , iLocationModel.LocationTitle );
                ...
                iSRoofingScreenChatShowMessageDatabaseModel.MessageType = "textmap";//iTranslationModel.MessageType;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageText = iLanguageModel.lblText_ScreenChatShow_ShareLocation_Message; //MessageText;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageCode_Translated = "en";//iTranslationModel.MessageCode_Translated;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageText_Translated = iLanguageModel.lblText_ScreenChatShow_ShareLocation_Message;// iTranslationModel.MessageText_Translated;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageCode_Original = "en";//iTranslationModel.MessageCode_Original;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageText_Original = iLanguageModel.lblText_ScreenChatShow_ShareLocation_Message;//iTranslationModel.MessageText_Original;
                ...
                iSRoofingScreenChatShowMessageDatabaseModel.MessageTextHistoryLine = SRoofingEnum_MessageText_HistoryLine_Code.MessageHistoryLineCode_Location;


                iSRoofingScreenChatShowMessageDatabaseModel.LocationLatitude = iLocationModel.LocationLatitude;
                iSRoofingScreenChatShowMessageDatabaseModel.LocationLongitude = iLocationModel.LocationLongitude;
                iSRoofingScreenChatShowMessageDatabaseModel.LocationAddress = iLocationModel.LocationTitle;
                iSRoofingScreenChatShowMessageDatabaseModel.LocationCityName = iLocationModel.CityName;
                iSRoofingScreenChatShowMessageDatabaseModel.LocationCountryName = iLocationModel.CountryName;
                iSRoofingScreenChatShowMessageDatabaseModel.LocationCountryCode = iLocationModel.CountryCode;
                iSRoofingScreenChatShowMessageDatabaseModel.CountryCode = iLocationModel.CountryCode;
                iSRoofingScreenChatShowMessageDatabaseModel.LocationCountryFlagURL = "0";
             
                
                iSRoofingScreenChatShowMessageDatabaseModel.ImageDefaultServerID = ImageID;
                iSRoofingScreenChatShowMessageDatabaseModel.ImageDefaultServerURL = _StaticMapURL;
                iSRoofingScreenChatShowMessageDatabaseModel.ImageThumServerURL = _StaticMapURL;
                ...
                iSRoofingScreenChatShowMessageDatabaseModel.ImageDefaultPath = _StaticMapURL; //fileResult.FullPath;
                ...
                _=   Task.Run ( async ( ) =>
                {
                    ...
                    SRoofingScreenChatShowHistoryMessageModelManager _iHistoryChatMessageModel = new SRoofingScreenChatShowHistoryMessageModelManager
                    {
                        ...
                        MessageText = iLanguageModel.lblText_ScreenChatShow_ShareLocation_Message ,
