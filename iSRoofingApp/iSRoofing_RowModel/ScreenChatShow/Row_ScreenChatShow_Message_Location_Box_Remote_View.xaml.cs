...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.ScreenChatShow
{
    ...
    public partial class Row_ScreenChatShow_Message_Location_Box_Remote_View : ContentView
    {
        public Row_ScreenChatShow_Message_Location_Box_Remote_View()
        {
            InitializeComponent();
            // 
        ...
        public static BindableProperty iOwnerModelProperty =
            BindableProperty.Create(
                ...
                typeof(Row_ScreenChatShow_Message_Location_Box_Remote_View),
        ...
        public static BindableProperty iGroupModelProperty =
            BindableProperty.Create(nameof(iGroupModel), typeof(SRoofingScreenChatShowMessageModelManager), typeof(Row_ScreenChatShow_Message_Location_Box_Remote_View), new SRoofingScreenChatShowMessageModelManager(),
                BindingMode.TwoWay);
           ...
           if (propertyName == iGroupModelProperty.PropertyName)
            {
                if (iGroupModel != null)
                {
                    ...
                    //img_Thum.Source = "img_theme_map_bg.png";// iGroupModel.ImageDefaultPath;
        ...
        public static readonly BindableProperty Command_Chat_ByUserProperty = BindableProperty.Create(nameof(Command_Chat_ByUser), typeof(ICommand), typeof(Row_ScreenChatShow_Message_Location_Box_Remote_View), null);
