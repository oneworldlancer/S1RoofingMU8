...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.ScreenChatShow
{
    ...
    public partial class Row_ScreenChatShow_Message_Command_Remote_View : ContentView
    {
        public Row_ScreenChatShow_Message_Command_Remote_View()
        {
            InitializeComponent();



            //IconTintColorEffect.SetTintColor(imgBtn_Copy, Colors.Orange);
    ...
    if (iGroupModel != null)
     ...
     SRoofingEnum_MessageCenter.MessageCenter_CHAT_NEW_SCREENCHATSHOW_MESSAGE , iBroadcastModel);
        ...
        async void imgBtn_Speak_Clicked(object sender, EventArgs e)
        {
            try
            {
                await TextToSpeech.SpeakAsync(iGroupModel.MessageText_Translated);
