...
public partial class Picker_Chat_Share_Dashboard : ContentPage
{
    ...
    public Picker_Chat_Share_Dashboard(
  ...
  SRoofingScreenChatShowMessageModelManager iMessageModel = null)
    ...
    private void Page_ChatterPickerDashboard_Loaded(object sender, EventArgs e)
    {
        try
        {
            ...
            SRoofing_DebugManager.Debug_ShowSystemMessage("Page_Load == Picker_Chat_Share_Dashboard");
