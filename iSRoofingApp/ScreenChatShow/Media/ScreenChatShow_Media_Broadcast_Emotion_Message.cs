...
using S1RoofingMU.iSRoofingApp.ScreenChatShow.Emotion;
...
{
    public class ScreenChatShow_Media_Broadcast_Emotion_Message
    {



        public static async Task Broadcast_ScreenChatShowMessageShareEmotionWS(
       ...
       SRoofingUserMediaModel iUserMediaModel ,
...
)
        {
            ...
            try
            {
                ...
                await Broadcast_ScreenChatShow_Emotion_Message
                           .Broadcast_ScreenChatShow_Emotion_MessageWS(
                       App.Current,
            iAccountType,
             iOwnerModel,
             MessageTokenID,
