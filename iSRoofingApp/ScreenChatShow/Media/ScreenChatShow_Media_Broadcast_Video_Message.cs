...
{
    public class ScreenChatShow_Media_Broadcast_Video_Message
    {

        public static async Task Broadcast_ScreenChatShowMessageShareVideoWS(
...
)
        {
            ...
            try
            {
                ...
                if ( IsUploadNew )
                {
                    ...
                    if ( iUserMediaModel.MediaFile_Code == ( SRoofingEnum_File_Code.FileCode_Video ) )
                    {


                        await SRoofing_UploadMediaManager.Uploader_MediaFile_VideoWS (
      ...
      App.URL_TlknUploader_VideoDataURL,
      iUserMediaModel );
                    }
                }
                ...
                await Broadcast_ScreenChatShow_Video_Message
                           .Broadcast_ScreenChatShow_Video_MessageWS (
