...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.Gallery.Chat
{
    ...
    public partial class Row_Gallery_Video_View : ContentView
    {
        public Row_Gallery_Video_View()
        {
            InitializeComponent();
        }
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            if (propertyName == iGroupModelProperty.PropertyName)
            {
                if (iGroupModel != null)
                {
                    ...
                    //imgBtn_Thum.Source = iGroupModel.VideoThumServerURL;
                    if (File.Exists(iGroupModel.VideoThumPath))
                    {
                        imgBtn_Thum.Source = iGroupModel.VideoThumPath;
                    }
                    else
                    {
                        imgBtn_Thum.Source = iGroupModel.VideoThumServerURL;
        ...
        async void sl_Play_Tapped(object sender, TappedEventArgs e)
        {
            try
            {
        ...
        private void frm_Avatar_Tapped(object sender, EventArgs e)
        {
            try
            {
