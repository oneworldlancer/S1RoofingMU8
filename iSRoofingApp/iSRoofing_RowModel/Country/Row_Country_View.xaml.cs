...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.Country;

public partial class Row_Country_View : ContentView
{
	public Row_Country_View()
	{
		InitializeComponent();
	}
    ...
    public SRoofingCountryModel iGroupModel
    {
        get
        {
            return (SRoofingCountryModel)GetValue(iGroupModelProperty);
        }
        set
        {
    ...
    public static BindableProperty iGroupModelProperty =
        BindableProperty.Create(nameof(iGroupModel), typeof(SRoofingCountryModel), typeof(Row_Country_View), new SRoofingCountryModel(),
            BindingMode.TwoWay);
    ...
    public static readonly BindableProperty Command_Call_ByUserProperty = BindableProperty.Create(nameof(Command_Call_ByUser), typeof(ICommand), typeof(Row_Country_View), null);
