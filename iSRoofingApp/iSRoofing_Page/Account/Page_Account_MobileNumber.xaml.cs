...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_Page.Account
{
    ...
    public partial class Page_Account_MobileNumber : ContentView
    {
        ...
        public Page_Account_MobileNumber()
        {
            InitializeComponent();
        ...
        async Task<string> Get_Password()
        {
            ...
            try
            {
                ...
                {
                    await ((Page_Account_Dashboard)Parent.BindingContext).Snack_ShowMessage("Check your pass code!");
        ...
        async void lblCountryList_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                ////////SRoofing_DebugManager.Debug_ShowSystemMessage("*************************************obj == "+ obj);
                    ...
                    if (Connectivity.NetworkAccess == NetworkAccess.Internet)
                    {
                       ...
                       App.Current, App.iAccountType, _iOwnerModel);
                            ...
                            && _register_Password == _iOwnerPassword)
                        {
                            ...
                            _iOwnerModel.CountryCode = _register_CountryCode;
                            ...
                            Task.Run(async () =>
                          {
                              await SRoofing_UserSettingManager.UserSetting_Update_MobileNumber_ByOwnerUserTokenID(
                                  App.Current,
               App.iAccountType,
               _iOwnerModel,
                _register_MobileNumberE164_Clean,
                _register_CountryCode,
                _register_CountryMobileCode);
        ...
        public async Task Initialize_AppTranslation(SRoofingLanguageTranslateModel _iLanguageModel)
        {
            try
            {
                ...
                //"S1Roofing " +
                lbl_Title.Text = _iLanguageModel.lblText_MobileNumber;
