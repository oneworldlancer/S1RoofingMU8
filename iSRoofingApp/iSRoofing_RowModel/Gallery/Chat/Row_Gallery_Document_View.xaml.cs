...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.Gallery.Chat
{
    ...
    public partial class Row_Gallery_Document_View : ContentView
    {
        public Row_Gallery_Document_View ( )
        {
            InitializeComponent ( );
        }
        ...
        async void sl_Download_Tapped ( object sender , EventArgs e )
        {
            try
            {
                await ( ( Page_Chat_Gallery_List ) Parent.BindingContext )
