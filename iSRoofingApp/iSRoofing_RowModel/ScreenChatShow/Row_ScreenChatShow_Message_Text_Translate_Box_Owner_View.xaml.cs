...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.ScreenChatShow
{
    ...
    public partial class Row_ScreenChatShow_Message_Text_Translate_Box_Owner_View : ContentView
    {
        public Row_ScreenChatShow_Message_Text_Translate_Box_Owner_View()
        {
            InitializeComponent();
            // 
        ...
        public static BindableProperty iOwnerModelProperty =
            BindableProperty.Create(
                ...
                typeof(Row_ScreenChatShow_Message_Text_Translate_Box_Owner_View),
        ...
        public static BindableProperty iGroupModelProperty =
            BindableProperty.Create(nameof(iGroupModel), typeof(SRoofingScreenChatShowMessageModelManager), typeof(Row_ScreenChatShow_Message_Text_Translate_Box_Owner_View), new SRoofingScreenChatShowMessageModelManager(),
                BindingMode.TwoWay);
    ...
    if (iGroupModel != null)
                {
                    ...
                    if (iGroupModel.MessageText!= null)
                    {
   lbl_MessageText.Text= "<small>" + iGroupModel.MessageText_Translated + "</Small><br/>" + iGroupModel.MessageText_Original ;

                    }
                    else
                    {
                        lbl_MessageText.Text = "Welcome to S1Roofing";
        ...
        public static readonly BindableProperty Command_Chat_ByUserProperty = BindableProperty.Create(nameof(Command_Chat_ByUser), typeof(ICommand), typeof(Row_ScreenChatShow_Message_Text_Translate_Box_Owner_View), null);
