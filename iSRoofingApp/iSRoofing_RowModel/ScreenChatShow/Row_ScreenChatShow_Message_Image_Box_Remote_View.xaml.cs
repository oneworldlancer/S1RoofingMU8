...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.ScreenChatShow
{
    ...
    public partial class Row_ScreenChatShow_Message_Image_Box_Remote_View : ContentView
    {
        public Row_ScreenChatShow_Message_Image_Box_Remote_View()
        {
            InitializeComponent();
            // 
        ...
        public static BindableProperty iOwnerModelProperty =
            BindableProperty.Create(
                ...
                typeof(Row_ScreenChatShow_Message_Image_Box_Remote_View),
        ...
        public static BindableProperty iGroupModelProperty =
            BindableProperty.Create(nameof(iGroupModel), typeof(SRoofingScreenChatShowMessageModelManager), typeof(Row_ScreenChatShow_Message_Image_Box_Remote_View), new SRoofingScreenChatShowMessageModelManager(),
                BindingMode.TwoWay);
        ...
        public static readonly BindableProperty Command_Chat_ByUserProperty = BindableProperty.Create(nameof(Command_Chat_ByUser), typeof(ICommand), typeof(Row_ScreenChatShow_Message_Image_Box_Remote_View), null);
