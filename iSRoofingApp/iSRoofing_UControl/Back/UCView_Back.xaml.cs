...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_UControl.Back
{
    ...
    public partial class UCView_Back : ContentView
    {
        public UCView_Back()
        {
            InitializeComponent();
    ...
    BindableProperty.Create(nameof(TitleText), typeof(string), typeof(UCView_Back), null);
    ...
    //    }
      ...
      async    private void img_BackX_Clicked(object sender, EventArgs e)
        {
            try
            {
