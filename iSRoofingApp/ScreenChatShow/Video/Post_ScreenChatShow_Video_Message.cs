...
{
    public class Post_ScreenChatShow_Video_Message
    {


        public static async Task Post_ScreenChatShowVideo_MessageWS(
 ...
 */
                ...
                iSRoofingScreenChatShowMessageDatabaseModel.MessageType = "textsharevideo";//iTranslationModel.MessageType;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageText = iLanguageModel.lblText_ScreenChatShow_ShareVideo_Message; //;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageCode_Translated = iTranslationModel.MessageCode_Translated;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageText_Translated = iLanguageModel.lblText_ScreenChatShow_ShareVideo_Message;// iTranslationModel.MessageText_Translated;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageCode_Original = iTranslationModel.MessageCode_Original;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageText_Original = iLanguageModel.lblText_ScreenChatShow_ShareVideo_Message;//iTranslationModel.MessageText_Original;
                ...
                iSRoofingScreenChatShowMessageDatabaseModel.MessageTextHistoryLine = SRoofingEnum_MessageText_HistoryLine_Code.MessageHistoryLineCode_Video;
                //https://www.floridaboatingandwatersports.com/site/wp-content/uploads/2021/05/Shark-Interactions.jpg

                iSRoofingScreenChatShowMessageDatabaseModel.VideoDefaultServerID = VideoID;// "0";
                iSRoofingScreenChatShowMessageDatabaseModel.VideoDefaultServerURL = SRoofing_URLManager.URL_Video.Video_Get_VideoDataByVideoID(App.Current, VideoID);// "http://media.w3.org/2010/05/sintel/trailer.mp4";
                iSRoofingScreenChatShowMessageDatabaseModel.VideoThumServerURL = SRoofing_URLManager.URL_Video.Video_Get_VideoThumByVideoID(App.Current, VideoID);// "https://assets.codepen.io/32795/poster.png";
                iSRoofingScreenChatShowMessageDatabaseModel.VideoThumPath = Path.Combine(FileSystem.Current.CacheDirectory, "thm_" + VideoID + ".jpg");//"0";
                iSRoofingScreenChatShowMessageDatabaseModel.VideoThumData = null;
                iSRoofingScreenChatShowMessageDatabaseModel.VideoDefaultPath = iUserMediaModel.MediaFile_LocalPathURL; //fileResult.FullPath; //"0";

                iSRoofingScreenChatShowMessageDatabaseModel.MediaFile_Code = SRoofingEnum_File_Code.FileCode_Video; //"0";
                iSRoofingScreenChatShowMessageDatabaseModel.MediaFile_Type = SRoofingEnum_File_Type.ShareType_Video; //"0";
                iSRoofingScreenChatShowMessageDatabaseModel.MediaFile_Size = iUserMediaModel.MediaFile_Size; //"0";
                ...
                _ = Task.Run(async () =>
                {
                    ...
                    SRoofingScreenChatShowHistoryMessageModelManager _iHistoryChatMessageModel = new SRoofingScreenChatShowHistoryMessageModelManager
                    {
                        ...
                        MessageText = iLanguageModel.lblText_ScreenChatShow_ShareVideo_Message,
            ...
            SRoofingEnum_MessageCenter.MessageCenter_CHAT_NEW_SCREENCHATSHOW_MESSAGE, iBroadcastModel);
                ...
                _ = Task.Run(async () =>
                {
                    if (iSettingModel.Media_DownloadVideo_IsEnable
                        && iSRoofingScreenChatShowMessageDatabaseModel.VideoDefaultPath == "0")
                    {
