...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.ScreenChatShow
{
    ...
    public partial class Row_ScreenChatShow_Message_Command_Share_Remote_View : ContentView
    {
        public Row_ScreenChatShow_Message_Command_Share_Remote_View ( )
        {
            InitializeComponent ( );
        ...
        private void imgBtn_Copy_Clicked ( object sender , EventArgs e )
        {
        ...
        async void imgBtn_Share_Clicked ( object sender , EventArgs e )
        {
            ...
            try
            {
         //       await ( ( Page_Chat_Dashboard ) Parent.BindingContext ).Picker_ShareMedia ( iGroupModel );
            }
            catch ( Exception ex )
            {
                SRoofing_DebugManager.Debug_ShowSystemMessage ( ex.Message.ToString ( ) );
