...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.ScreenChatShow
{
    ...
    public partial class Row_ScreenChatShow_Message_Image_Remote_View : ContentView
    {
        public Row_ScreenChatShow_Message_Image_Remote_View ( )
        {
            InitializeComponent ( );
            // 
        ...
        //iParent
        public Page_ScreenChatShow_Dashboard iParent
        {
            get
            {
                return ( Page_ScreenChatShow_Dashboard ) GetValue ( iParentProperty );
            }
            set
            {
        ...
        public static BindableProperty iParentProperty =
            BindableProperty.Create (
                ...
                typeof ( Row_ScreenChatShow_Message_Image_Remote_View ) ,
        ...
        public static BindableProperty iGroupModelProperty =
            BindableProperty.Create ( nameof ( iGroupModel ) , typeof ( SRoofingScreenChatShowMessageModelManager ) , typeof ( Row_ScreenChatShow_Message_Image_Remote_View ) , new SRoofingScreenChatShowMessageModelManager ( ) ,
                BindingMode.TwoWay );
        ...
        protected override void OnPropertyChanged ( string propertyName = null )
        {
            ...
            else if ( propertyName == iParentProperty.PropertyName )
            {
                SRoofing_DebugManager.Debug_ShowSystemMessage ( "@@@@@@@@@@@@@@@-iParentProperty-@@@@@@@@@@@@@@@" );
                SRoofing_DebugManager.Debug_ShowSystemMessage ( "@@@@@@@@@@@@@@@-" + iParent.Title + "-@@@@@@@@@@@@@@@" );
        ...
        public static readonly BindableProperty Command_Chat_ByUserProperty = BindableProperty.Create ( nameof ( Command_Chat_ByUser ) , typeof ( ICommand ) , typeof ( Row_ScreenChatShow_Message_Image_Remote_View ) , null );
