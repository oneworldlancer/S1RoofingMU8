...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.Alphabet
{
    ...
    public partial class Row_Alphabet_View : ContentView
    {
        public Row_Alphabet_View()
        {
            InitializeComponent();
        }
        ...
        public static BindableProperty iParentProperty =
            BindableProperty.Create(nameof(iParent), typeof(Page_Contact_List_Dashboard), typeof(Row_Alphabet_View), new Page_Contact_List_Dashboard(),
                BindingMode.TwoWay);
        ...
        public static BindableProperty iKeyValueModelProperty =
            BindableProperty.Create(nameof(iKeyValueModel), typeof(SRoofingKeyValueModelManager), typeof(Row_Alphabet_View), new SRoofingKeyValueModelManager(),
                BindingMode.TwoWay);
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            if (propertyName == iKeyValueModelProperty.PropertyName)
            {
                if (iKeyValueModel != null)
                {
                    ...
                    if (iKeyValueModel.ItemCode == "disable")
                    {
                        lbl_AlphabetChar.BackgroundColor = Color.FromArgb("#454545");
                        lbl_AlphabetChar.TextColor = Color.FromArgb("#c0c0c0");
                        lbl_AlphabetChar.IsEnabled = false;
                    }

                    else if (iKeyValueModel.ItemCode == "active")
                    {
                        // lbl_AlphabetChar.BackgroundColor = ( Color ) Application.Current.Resources[ "iAppColor_SemiGray" ];
                        lbl_AlphabetChar.BackgroundColor = Color.FromArgb("#454545");
                        lbl_AlphabetChar.TextColor = Color.FromArgb("#ff8000");
                        lbl_AlphabetChar.IsEnabled = true;

                    }
                    else if (iKeyValueModel.ItemCode == "select")
                    {
                        lbl_AlphabetChar.BackgroundColor = Color.FromArgb("#000000");;
                        lbl_AlphabetChar.TextColor = Color.FromArgb("#ff8000");
                        lbl_AlphabetChar.IsEnabled = false;
        ...
        public static readonly BindableProperty Command_Call_ByUserProperty = BindableProperty.Create(nameof(Command_Call_ByUser), typeof(ICommand), typeof(Row_Alphabet_View), null);
        ...
        private async void lbl_AlphabetChar_Tapped(object sender, EventArgs e)
        {
            try
            {
                ...
                Command_Call_ByUser.Execute(iKeyValueModel);
