...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_WebService_InterfaceManager
    {
    public interface ISRoofing_UserContactFriendWS
        {

        //<ObservableCollection<SRoofingLogisticsStaffModelManager>>
        Task<ObservableCollection<SRoofingUserRemoteModelManager>> SRoofing_XFMobile_UserContactFriend_Get_List_Contact_ByAlphabetIndexWSAsync (
