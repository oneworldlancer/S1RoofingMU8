...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.ScreenChatShow
{
    ...
    public partial class Row_ScreenChatShow_Message_UserName_Remote_View : ContentView
    {
        public Row_ScreenChatShow_Message_UserName_Remote_View()
        {
            InitializeComponent();
            // 
    ...
    if (iGroupModel != null)
                {
                    ...
                    lbl_UserName.Text = iGroupModel.NameLine;
