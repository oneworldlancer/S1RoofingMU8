...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_SyncManager
    {
    class SRoofingSync_User_Owner_Manager
        {
        ...
        public async static
        void Sync_User_Owner_Set_UserModel (
        ...
        public static
          SRoofingUserOwnerModelManager Sync_User_Owner_Get_UserModel ( Application _context )
            {
        ...
        public static
        Task Sync_User_Owner_Update_UserModel (
            ...
            try
                {
                   ...
                   ObservableCollection <SRoofingUserOwnerModelManager> arrOwnerModelManager = new ObservableCollection <SRoofingUserOwnerModelManager> ();

                          arrOwnerModelManager  .Add ( iOwnerModel);
                string jsonList = JsonConvert.SerializeObject ( arrOwnerModelManager );
