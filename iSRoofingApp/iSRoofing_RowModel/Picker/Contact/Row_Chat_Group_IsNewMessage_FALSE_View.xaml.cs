...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.Picker.Contact
{
    ...
    public partial class Row_Chat_Group_IsNewMessage_FALSE_View : ContentView
    {
        public Row_Chat_Group_IsNewMessage_FALSE_View()
        {
            InitializeComponent();
            // 
        ...
        public static BindableProperty iOwnerModelProperty =
            BindableProperty.Create(
                ...
                typeof(Row_Chat_Group_IsNewMessage_FALSE_View),
        ...
        public static BindableProperty iGroupModelProperty =
            BindableProperty.Create(nameof(iGroupModel), typeof(SRoofingScreenChatShowHistoryMessageModelManager), typeof(Row_Chat_Group_IsNewMessage_FALSE_View), new SRoofingScreenChatShowHistoryMessageModelManager(),
                BindingMode.TwoWay);
        ...
        //public static readonly BindableProperty Command_Chat_ByUserProperty = BindableProperty.Create(nameof(Command_Chat_ByUser), typeof(ICommand), typeof(Row_Chat_Group_IsNewMessage_FALSE_View), null);
