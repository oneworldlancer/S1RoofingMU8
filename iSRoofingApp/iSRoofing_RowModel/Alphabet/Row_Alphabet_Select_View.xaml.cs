...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.Alphabet
    ...
    public partial class Row_Alphabet_Select_View : ContentView
        {
        public Row_Alphabet_Select_View ( )
            {
            InitializeComponent ( );
            }
        ...
        public static BindableProperty iOwnerModelProperty =
            BindableProperty.Create(
                ...
                typeof(Row_Alphabet_Select_View),
        ...
        public static BindableProperty iKeyValueModelProperty =
            BindableProperty.Create ( nameof ( iKeyValueModel ) , typeof ( SRoofingKeyValueModelManager ) , typeof ( Row_Alphabet_Select_View ) , new SRoofingKeyValueModelManager ( ) ,
                BindingMode.TwoWay );
        ...
        public static readonly BindableProperty Command_Call_ByUserProperty = BindableProperty.Create ( nameof ( Command_Call_ByUser ) , typeof ( ICommand ) , typeof ( Row_Alphabet_Select_View ) , null );
        ...
        async void lbl_AlphabetChar_Tapped ( object sender , EventArgs e )
            {
            try
                {
                ...
                //if ( iParent.ClickCommand.CanExecute ( iKeyValueModel ) )
                //    iParent.ClickCommand.Execute ( iKeyValueModel );

         iParent.Initialize_List_Contact_Reset ( iKeyValueModel.ItemText );
