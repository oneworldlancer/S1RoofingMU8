...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_Page.Picker.Share;
...
public partial class View_Chat_Share_List : ContentView
{
    ...
    public async Task Preload(Picker_Chat_Share_Dashboard iParent)
    {
        try
        {
            ...
            //if (iParent != null)
            //{
            //    ((Picker_Chat_Share_Dashboard)Parent.BindingContext) = iParent;
            //    _iOwnerModel = ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iOwnerModel;
            //}
            ...
            MainThread.BeginInvokeOnMainThread(() =>
            {
                ...
                //btn_New_Chatter.Text = ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iLanguageModel.lblText_Group_AddUser_Message;
                // btn_Close_MenuRight.Text = ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iLanguageModel.lblText_Command_CLOSE_Message;
    ...
    public async Task Initialize()
    {
        try
        {
            ...
            arr_UserChattersList_Temp = await App.Database.Get_List_History_Chat_Message_ByOwnerUserTokenID(((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iOwnerModel, ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iSettingModel);
            ...
            //         ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iLanguageModel,
            //        ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iOwnerModel,
            //        ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iChatScreenModel.GroupTokenID);
    ...
    async Task Fetch_List()
    {
        try
        {
            ...
            arr_UserChattersList_Temp = await SRoofing_History_ScreenChatShowManager
                 ...
                 App.Current, ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iOwnerModel, ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iLanguageModel);
    ...
    async void btn_New_Chatter_Clicked(object sender, EventArgs e)
    {
        try
        {
            ...
            await ((Picker_Chat_Share_Dashboard)Parent.BindingContext).Show_PickerContactList();
            ...
            //////////        if (currentPage.GetType() != typeof(Picker_Chat_Share_Dashboard))
            //////////        {
            //////////            await Navigation.PushModalAsync(new Picker_Chat_Share_Dashboard(
            //////////   ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iApplicationUtilityModel,
            //////////   ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iSettingModel,
            //////////   ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iLanguageModel,
            //////////      ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iOwnerModel,
            //////////  ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iSpeechModel,
            //////////   ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iOwner_Incoming_LanguageCode,
            //////////     ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iOwner_Outgoing_LanguageCode,
            //////////    ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iChatScreenModel), true);
...
_pending_iRemoteModel);
    ...
    async Task ShowList()
    {
        try
        {
            ...
            await ((Picker_Chat_Share_Dashboard)Parent.BindingContext).Close_LoadingScreen();
        ...
        try
        {
            ...
            if (_pending_iRemoteModel != null)
            {
                ...
                MainThread.BeginInvokeOnMainThread(async () =>
                {
                    ...
                    // Code to run on the main thread
                    // show progressbar
                    await ((Picker_Chat_Share_Dashboard)Parent.BindingContext).iProgress_Start();
                ...
                MainThread.BeginInvokeOnMainThread(async () =>
                {
                    ...
                    // Code to run on the main thread
                    // hide progressbar
                    await ((Picker_Chat_Share_Dashboard)Parent.BindingContext).iProgress_Stop();
                ...
                SRoofingScreenChatShowHistoryMessageModelManager iGroupModel)
    {
        ...
        try
        {
            ...
            if (((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iMessageModel!= null)
            {

                if (Connectivity.NetworkAccess == NetworkAccess.Internet)
                {

                    if (((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iMessageModel.MediaFile_Code == SRoofingEnum_File_Type.ShareType_Image)
                    {
              ...
              ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iApplicationUtilityModel,
                    ...
                    ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iLanguageModel,
                       _iOwnerModel,
               ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iChatScreenModel.iGroupModel,
                       ...
                       ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iOwner_Incoming_LanguageCode,
                         ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iOwner_Outgoing_LanguageCode,
                             ...
                             iGroupModel.GroupTokenID,
                               ...
                               ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iLanguageModel.lblText_ScreenChatShow_ShareImage_Message,

                     "media",
                                    "image",

        ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iMessageModel.ImageDefaultServerURL,

                  ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iMessageModel.ImageDefaultServerID,
        null,
                     //null,
                     //        null,
                     ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iMessageModel.ImageDefaultServerURL, "0", "0",
          false,
        ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iMessageModel);
                    ...
                    else if (((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iMessageModel.MediaFile_Code == SRoofingEnum_File_Type.ShareType_Video)
                    {
        ...
        ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iSpeechModel,
                     ...
                     ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iOwner_Outgoing_LanguageCode,
                          ...
                          ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iLanguageModel.lblText_ScreenChatShow_ShareVideo_Message,
        ...
        ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iMessageModel.VideoDefaultServerURL,

                  ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iMessageModel.VideoDefaultServerID,
                       ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iMessageModel.VideoDefaultServerURL,
        null,
        ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iMessageModel.VideoDefaultServerURL,
                     "0", "0",
         ...
         ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iMessageModel);
                    ...
                    else if (((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iMessageModel.MediaFile_Code == SRoofingEnum_File_Type.ShareType_Document)
                    {
        ...
        ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iSpeechModel,
                     ...
                     ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iOwner_Outgoing_LanguageCode,
                          ...
                          ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iLanguageModel.lblText_ScreenChatShow_ShareDocument_Message,
        ...
        ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iMessageModel.ImageDefaultServerURL,
         ...
         ((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iMessageModel);
                ...
                {
                    await SRoofing_ToastMessageManager.ToastMessage_Show_Message(((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iLanguageModel.lblText_Connection_CheckOnline_Message);
                }

            }
            else
            {
                await SRoofing_ToastMessageManager.ToastMessage_Show_Message(((Picker_Chat_Share_Dashboard)Parent.BindingContext)._iLanguageModel.lblText_AppError_TryAgainLater);
            }
