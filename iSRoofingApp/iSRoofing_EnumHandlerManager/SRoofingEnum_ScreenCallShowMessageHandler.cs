...
{
    class SRoofingEnum_ScreenCallShowMessageHandler
    {


        public static string ScreeCallShow_New_Event_Message_ByScreenCallShowID = "101";
     
        public static string ScreeCallShow_Call_Offer_Message_ByScreenCallShowID = "102";
