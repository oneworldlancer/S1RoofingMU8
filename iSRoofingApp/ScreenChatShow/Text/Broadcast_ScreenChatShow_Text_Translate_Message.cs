...
{
    public class Broadcast_ScreenChatShow_Text_Translate_Message
    {

        public static async
Task<string> Broadcast_ScreenChatShow_Text_Translate_MessageWS (
                    ...
                    string UserDateYearWS )
        {
            ...
            try
            {
                ...
                .SRoofing_XFMobile_ScreenChatShowMessage_SendScreenChatShowTextTranslateMessageWSAsync (
