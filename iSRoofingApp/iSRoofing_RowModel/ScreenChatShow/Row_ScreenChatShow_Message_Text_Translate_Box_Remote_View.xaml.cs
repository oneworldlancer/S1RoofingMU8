...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.ScreenChatShow
{
    ...
    public partial class Row_ScreenChatShow_Message_Text_Translate_Box_Remote_View : ContentView
    {
        public Row_ScreenChatShow_Message_Text_Translate_Box_Remote_View()
        {
            InitializeComponent();
            // 
