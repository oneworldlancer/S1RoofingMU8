...
namespace S1RoofingMU.iSRoofingApp.iSRoofing_RowModel.Chatter
{
    ...
    public partial class Row_Chatter_Remote_View : ContentView
    {
        public Row_Chatter_Remote_View()
        {
            InitializeComponent();
            // 
        ...
        public static BindableProperty iParentProperty =
            BindableProperty.Create(
                ...
                typeof(Row_Chatter_Remote_View),
        ...
        public static BindableProperty iGroupModelProperty =
            BindableProperty.Create(nameof(iGroupModel), typeof(SRoofingUserRemoteModelManager), typeof(Row_Chatter_Remote_View), new SRoofingUserRemoteModelManager(),
                BindingMode.TwoWay);
        ...
        public static readonly BindableProperty Command_Chatter_ByUserProperty = BindableProperty.Create(nameof(Command_Chatter_ByUser), typeof(ICommand), typeof(Row_Chatter_Remote_View), null);
        ...
        private async void btn_Command_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                await ((S1RoofingMU.iSRoofingApp.iSRoofing_Page.Picker.Chatter.View_Chat_Chatters_List)Parent.BindingContext)
                        .pendingRemove_Chatter((SRoofingUserRemoteModelManager)iGroupModel);
