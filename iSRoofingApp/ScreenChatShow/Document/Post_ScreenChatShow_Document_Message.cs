...
{
    public class Post_ScreenChatShow_Document_Message
    {


        public static async Task Post_ScreenChatShowDocument_MessageWS (
 ...
 */
                ...
                iSRoofingScreenChatShowMessageDatabaseModel.MessageType = "textsharedocument";//iTranslationModel.MessageType;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageText = iLanguageModel.lblText_ScreenChatShow_ShareDocument_Message; //DocumentTitle.Replace ( "-" , "_" );
                iSRoofingScreenChatShowMessageDatabaseModel.MessageCode_Translated = iTranslationModel.MessageCode_Translated;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageText_Translated = iLanguageModel.lblText_ScreenChatShow_ShareDocument_Message; //DocumentTitle;// fileResult.FileName.Replace ( "-" , "_" ); ;// iTranslationModel.MessageText_Translated;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageCode_Original = iTranslationModel.MessageCode_Original;
                iSRoofingScreenChatShowMessageDatabaseModel.MessageText_Original = iLanguageModel.lblText_ScreenChatShow_ShareDocument_Message; //DocumentTitle;// fileResult.FileName.Replace ( "-" , "_" ); ;//iTranslationModel.MessageText_Original;
                ...
                iSRoofingScreenChatShowMessageDatabaseModel.MessageTextHistoryLine = SRoofingEnum_MessageText_HistoryLine_Code.MessageHistoryLineCode_Document;


                iSRoofingScreenChatShowMessageDatabaseModel.ImageDefaultServerID = DocumentID;
                iSRoofingScreenChatShowMessageDatabaseModel.ImageDefaultServerURL = SRoofing_URLManager.URL_Document.Document_Get_DocumentDataByDocumentID ( App.Current , DocumentID , DocumentTitle , DocumentExtension );
                iSRoofingScreenChatShowMessageDatabaseModel.ImageThumServerURL = "0";//SRoofing_URLManager.URL_Image.Image_Get_ImageByImageID ( App.Current, DocumentID );  
                ...
                iSRoofingScreenChatShowMessageDatabaseModel.ImageDefaultPath = ImagePathURL;


                iSRoofingScreenChatShowMessageDatabaseModel.MediaFile_Code = SRoofingEnum_File_Code.FileCode_Document; //"0";
                iSRoofingScreenChatShowMessageDatabaseModel.MediaFile_Type = SRoofingEnum_File_Type.ShareType_Document; //"0";
                ...
                iSRoofingScreenChatShowMessageDatabaseModel.MediaFile_Title = iUserMediaModel.MediaFile_Title; //"0";
                iSRoofingScreenChatShowMessageDatabaseModel.MediaFile_Extension = iUserMediaModel.MediaFile_Extension; //"0";
                ...
                iSRoofingScreenChatShowMessageDatabaseModel.IsMediaGallerySlideShow = false;
                ...
                _ = Task.Run ( async ( ) =>
                 {
                     ...
                     SRoofingScreenChatShowHistoryMessageModelManager _iHistoryChatMessageModel = new SRoofingScreenChatShowHistoryMessageModelManager
                     {
                         ...
                         MessageText = iLanguageModel.lblText_ScreenChatShow_ShareDocument_Message ,
             ...
             SRoofingEnum_MessageCenter.MessageCenter_CHAT_NEW_SCREENCHATSHOW_MESSAGE , iBroadcastModel );
                ...
                _ = Task.Run ( async ( ) =>
                {
                    if ( iSettingModel.Media_DownloadDocument_IsEnable
